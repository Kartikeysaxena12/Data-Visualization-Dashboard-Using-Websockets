...
const Feedback = () => {
  ...
  return (
    <div className="feedback-page flex flex-col md:flex-row items-start mr-40 space-x-4 mt-20 mx-auto max-w-5xl">
      <div className="p-4 w-7/12 max-w-xl bg-zinc-100 rounded-lg shadow-md">
